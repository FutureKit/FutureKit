...
internal final class Atomic<Value> {
	...
	@discardableResult
	internal func modify<Result>(_ action: (inout Value) throws -> Result) rethrows -> Result {
		lock.lock()
		defer { lock.unlock() }
	...
	/// - returns: The result of the action.
	@discardableResult
	internal func withValue<Result>(_ action: (Value) throws -> Result) rethrows -> Result {
		lock.lock()
		defer { lock.unlock() }
	...
	@discardableResult
	internal func swap(_ newValue: Value) -> Value {
